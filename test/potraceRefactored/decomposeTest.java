...
public class decomposeTest {
    ...
    public void test_findPath_boundary() {
        ...
        potraceOriginal.Path result = Decompose.findpath(testBitmap,63,1,43,4);
    ...
    public void test_xor_path() {
        ...
        potraceOriginal.Path path = Decompose.findpath(testBitmap,0,3,43,4);
