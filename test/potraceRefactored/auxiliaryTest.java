...
import potraceOriginal.Auxiliary;
...
public class auxiliaryTest {
    ...
    public void testMethod_Interval()  {
        potraceOriginal.DPoint firstPoint = new potraceOriginal.DPoint(1.2,3.4);
        potraceOriginal.DPoint secondPoint = new potraceOriginal.DPoint(3.5,8.1);
        double lampda = 0.5;

        potraceOriginal.DPoint expected = new potraceOriginal.DPoint(2.3499999999999996,5.75);
