...
public class listTest {
    potraceOriginal.Path first, second, third, fourth;

    @Before
    public void initializePathes() {
        first = new potraceOriginal.Path();
        second = new potraceOriginal.Path();
        third = new potraceOriginal.Path();
        fourth = new potraceOriginal.Path();
    }
    ...
    public void testMethod_elementInsertAtTheLastNextOfList_WithInsertingAListOfPathesAtTheEnd_ShouldFail(){
        potraceOriginal.Path listOfSecondToFourht = second;
