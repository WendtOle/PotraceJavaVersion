...
public class bitmapTest {
    ...
    public void testBMPutAndBMGetFunction() {
        ...
        assertEquals("with one potraceOriginal word in line: ",true, Bitmap.BM_GET(smallTestBitmap,0,0));

        Bitmap bigTestBitmap = new Bitmap(100,100);
        Bitmap.BM_PUT(bigTestBitmap,99,99,true);
        assertEquals("with more than one potraceOriginal word in line: ",true, Bitmap.BM_GET(bigTestBitmap,99,99));
    }
