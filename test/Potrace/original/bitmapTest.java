...
public class bitmapTest {
    ...
    public void testBMPutAndBMGetFunction() {
        ...
        assertEquals("with one Potrace.original word in line: ",true, BitmapManipulator.BM_GET(smallTestBitmap,0,0));

        Bitmap bigTestBitmap = new Bitmap(100,100);
        BitmapManipulator.BM_PUT(bigTestBitmap,99,99,true);
        assertEquals("with more than one Potrace.original word in line: ",true, BitmapManipulator.BM_GET(bigTestBitmap,99,99));
    }
